...
export const scoringCards: Scoring[] = [
  ...
  new IndexPlusScoring("E-002", "夏爾洛特 皇女", 1, "生活", 2),
  new IndexPlusScoring("E-003", "騎士公主 甘娜許", 1, "據點", 1),
  new IndexPlusScoring("E-004", "球形關節少女", 0, "零件", 2),
  new IndexPlusScoring("E-005", "人狼女王", 2, "力量", 3, 5),
  new IndexPlusScoring("E-006", "聖女馬卡龍", 1, "深淵洞穴", 0.5),
  new IndexPlusScoring("E-009", "傳奇旅行商人費蕾茲", 1, "商業", 2),
  new IndexPlusScoring("E-010", "勇者蘿謝特", 1, "迷宮板塊", 2),
  new IndexPlusScoring("E-011", "流浪魔女歐貝拉", 1, "藥水", 2, 5),
  new IndexPlusScoring("R-003", "地城保險", 1, "商業", 2),
  new IndexPlusScoring("R-014", "空白的百科全書", 1, "零件", 2),
  new IndexPlusScoring("R-013", "聖艾爾摩之火", 1, "生活", 2),
